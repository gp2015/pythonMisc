...
class TopicModel(_Model):
    ...
    :func:`graphlab.topic_model.create` to create an instance
    ...
    def _training_stats(self):
        ...
        ret = {k : self.get(k) for k in stat_fields}
        return ret
    ...
    def evaluate(self, train_data, test_data=None, metric='perplexity'):
        ...
        :py:func:`~graphlab.topic_model.perplexity` for more details.
        ...
        See :py:func:`~graphlab.topic_model.TopicModel.predict` for details
        on how these predictions are made, and see
        :py:func:`~graphlab.text_analytics.random_split` for a helper function
        ...
        See Also
        --------
        predict, graphlab.toolkits.text_analytics.random_split

        Examples
        --------
        >>> docs = graphlab.SArray('http://s3.amazonaws.com/dato-datasets/nips-text')
        >>> train_data, test_data = graphlab.text_analytics.random_split(docs)
...
def perplexity(test_data, predictions, topics, vocabulary):
    ...
    predictions : SArray
        ...
        :py:func:`~graphlab.topic_model.TopicModel.predict`, for example.
    ...
    topics : SFrame
        ...
        where m is a trained :py:class:`~graphlab.topic_model.TopicModel`.
    ...
    Examples
    --------
    >>> from graphlab import topic_model
    >>> train_data, test_data = graphlab.text_analytics.random_split(docs)
    ...
    response = _graphlab.toolkits._main.run("text_topicmodel_get_perplexity",
                                           opts)
