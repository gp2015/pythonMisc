...
class Ec2Config(object):
    ...
    security_group : str, optional
        ...
        rules will be added to this security group. If security_group is not given,
        we will create a new security group called 'GraphLab' with the necessary
        rules.
    ...
    security_group_id : str, optional
        The ID of the security group for the EC2 instance to use. This is needed
        if you want to launch using a already defined security group from a non-default VPC.
        The necessary rules will be added to this security group.
