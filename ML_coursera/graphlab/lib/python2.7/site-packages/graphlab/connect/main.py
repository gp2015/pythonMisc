...
from graphlab._distributed_execution_environment import clear_distributed_execution_environment
...
atexit.register(clear_distributed_execution_environment)
