...
class KmeansModel(_Model):
    ...
    def __repr__(self):
        ...
        extra.append(key_str.format("   cluster_id", width,
                     "An SFrame containing the cluster assignments."))
        extra.append(key_str.format("   cluster_info", width,
                     "An SFrame containing the cluster centers."))
...
def create(dataset, num_clusters=None, features=None, initial_centers=None,
    ...
    computed cluster centers and the cluster assignment for each instance in the
    dataset.
    ...
    initial_centers : SFrame, optional
        ...
        *initial_centers* SFrame must contain the columns specified in the
        *features* argument.

        If not specified (the default), initial centers are chosen intelligently
    ...
    It's often important to standardize the features for the k-means algorithm.
