...
class BoostedTreesClassifier(_Classifier, _TreeModelMixin):
    ...
    def show(self, view="Summary", tree_id=0, vlabel_hover=False):
        """
        Visualize a boosted trees classifier model.

        Parameters
        ----------
        view : str, optional
            The type of view to show in Canvas. Can be one of:
        ...
        return super(_Classifier, self).show(view=view)
    ...
    def evaluate(self, dataset, metric='auto', missing_value_action='auto'):
        ...
        _mt._get_metric_tracker().track(
                'toolkit.classifier.boosted_trees_classifier.evaluate')
    ...
    def classify(self, dataset, missing_value_action='auto'):
        ...
        """
        _mt._get_metric_tracker().track('toolkit.classifier.boosted_trees_classifier.classify')
