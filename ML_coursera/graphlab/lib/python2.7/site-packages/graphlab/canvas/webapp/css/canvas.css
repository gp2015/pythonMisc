...
.canvas-sframe-column-header[data-tooltip]:hover:after {
...
table.canvas-ps-deployed-table th:first-child {
  padding-left: 20px;
  width: 60%;
  font-size: 16px;
  font-weight: 400;
}
table.canvas-ps-deployed-table th {
  padding-left: 20px;
  width: 20%;
  font-size: 16px;
  font-weight: 400;
}
table.canvas-ps-deployed-table td:first-child {
  padding-left: 20px;
  width: 60%;
  font-size: 15px;
  font-weight: 400;
...
table.canvas-ps-deployed-table td {
  padding-left: 20px;
  width: 20%;
  font-size: 15px;
  font-weight: 400;
...
.canvas-model-summary-table tbody td:first-child {
 padding-left: 0px;
 width: 1px;
 white-space: nowrap;
 text-align: left;
...
.canvas-model-summary-table tbody td {
 padding-left: 0px;
 white-space: nowrap;
 text-align: right;
}

.canvas-model-summary-table tbody tr:nth-child(even) {
  background-color: #EEE;
}

.canvas-model-summary-table tbody tr:last-child{
   background-color: #FFF;
}
